...
namespace Reminder.Storage.InMemory.Tests
{
	...
	public class InMemoryReminderStorageTests
	{
		...
		{
			var reminder = new ReminderItem(DateTimeOffset.Now, "Hello!", "New ID", ReminderItemStatus.Awaiting);
		...
		{
			var id = Guid.NewGuid();
			var reminder = new ReminderItem(id, DateTimeOffset.Now, "Hello!", "New ID", ReminderItemStatus.Awaiting);
			var reminderWithNewData = new ReminderItem(id, DateTimeOffset.Now, "Bye! Bye!", "ID of new reminder", ReminderItemStatus.Awaiting);
			var testStorage = new InMemoryReminderStorage();
		...
		{
			var reminder = new ReminderItem(DateTimeOffset.Now, "Hello!", "New ID", ReminderItemStatus.Awaiting);
			var reminderWithNewData = new ReminderItem(DateTimeOffset.Now, "Bye! Bye!", "ID of new reminder", ReminderItemStatus.Awaiting);
			var testStorage = new InMemoryReminderStorage();
		...
		{
			var reminder = new ReminderItem(DateTimeOffset.Now, "Hello!", "New ID", ReminderItemStatus.Awaiting);
			var reminder1 = new ReminderItem(DateTimeOffset.Now, "Hello!", "New ID", ReminderItemStatus.Awaiting);
			var reminder2 = new ReminderItem(DateTimeOffset.Now, "Hello!", "New ID", ReminderItemStatus.Awaiting);
			var testStorage = new InMemoryReminderStorage();
		...
		public void Get_List_Of_Objects_With_Statuses_ReadyToSend_And_Failed()
		{
			...
			var reminder1 = new ReminderItem(DateTimeOffset.Now, "Hello!", "New ID", ReminderItemStatus.Awaiting);
			var reminder2 = new ReminderItem(DateTimeOffset.Now, "Hello!", "New ID", ReminderItemStatus.Awaiting);
			var reminder3 = new ReminderItem(DateTimeOffset.Now, "Hello!", "New ID", ReminderItemStatus.Awaiting);
			reminder3.Status = ReminderItemStatus.ReadyToSend;
			var reminder4 = new ReminderItem(DateTimeOffset.Now, "Hello!", "New ID", ReminderItemStatus.Awaiting);
			reminder4.Status = ReminderItemStatus.ReadyToSend;
			var reminder5 = new ReminderItem(DateTimeOffset.Now, "Hello!", "New ID", ReminderItemStatus.Awaiting);
